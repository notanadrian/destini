...
class StoryBrain {
  ...
  if (choiceNumber == 1 && _storyNumber == 0){
    ...
    _storyNumber = 4;    //Step 22 - In nextStory() if the storyNumber is equal to 3 or 4 or 5, that means it's the end of the game and it should call a method called restart() that resets the storyNumber to 0.
